    ...
    <main className="flex min-h-screen flex-col">
      <section className="w-full items-center background-custom">
        ...
        <div className="flex justify-center">
          <Button variant="ghost" className="items-center" onClick={scrollToNextSection}>
            <ChevronDown />
            {t("viewMore")} . . .
          </Button>
        </div>
      ...
      <section className="container mb-16">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="rounded-lg border border-gray-300 p-6 hover:bg-gray-100 hover:dark:bg-neutral-800/30">
            ...
            <p className="text-sm opacity-70">{t("expertTechniciansMessage")}</p>
          </div>
          <div className="rounded-lg border border-gray-300 p-6 hover:bg-gray-100 hover:dark:bg-neutral-800/30">
            <h3 className="text-xl font-semibold mb-3">
              {t("qualityPartsTitle")}
          ...
          <div className="rounded-lg border border-gray-300 p-6 hover:bg-gray-100 hover:dark:bg-neutral-800/30">
            ...
            <p className="text-sm opacity-70">{t("customerSatisfactionMessage")}</p>
          </div>
        </div>
      </section>

      <section className="container text-center">
        <h2 className="text-3xl font-semibold mb-6">{t("testimonials")}</h2>
        <p className="text-lg mb-6">{t("description")}</p>
        <CarouselPlugin />
      </section>

      <section className="container text-center">
        <h2 className="text-3xl font-semibold mt-8 mb-6">{t("getStarted")}</h2>
